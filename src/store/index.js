...
export default createStore({
  ...
  mutations: {
    ...
    setCheckedSauce(state, payload) {
      const index = state.sauces.findIndex(el => el.id === payload.id);
      state.sauces[index].cheched = payload.checked;
    },
    uncheckedSauce(state, id) {
      const index = state.sauces.findIndex(el => el.id === id);
      state.sauces[index].checked = false;
    },
    addIngredient(state, id) {
      const index = state.ingredients.findIndex(el => el.id === id);
      state.ingredients[index].count++;
    },
    incrementIngredient(state, id) {
      const index = state.ingredients.findIndex(el => el.id === id);
